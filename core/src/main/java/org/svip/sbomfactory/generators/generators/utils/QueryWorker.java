...
public abstract class QueryWorker implements Runnable {
    ...
    protected static HttpURLConnection queryURL(String urlString, boolean allowRedirects) {
        ...
        try {
            ...
            // Attempt to connect
            Debug.log(Debug.LOG_TYPE.DEBUG, "Attempting to connect to URL: " + url);
            ...
            Debug.log(Debug.LOG_TYPE.DEBUG, String.format(
            ...
            Debug.log(Debug.LOG_TYPE.WARN, String.format("Failed to query URL: '%s'", urlString));
        }
    ...
    protected static String getUrlContents(HttpURLConnection urlConnection) {
        ...
        try {
            ...
            Debug.log(Debug.LOG_TYPE.WARN, String.format("Failed to get contents of URL: '%s'", urlConnection.getURL().toString()));
        }
