package org.svip.sbomfactory.generators.generators.generators.cyclonedx;

import org.svip.sbomfactory.generators.generators.generators.CycloneDXGenerator;
import org.svip.sbomfactory.generators.generators.generators.GeneratorException;
import org.svip.sbomfactory.generators.generators.generators.License;
import org.svip.sbomfactory.generators.generators.generators.Tool;
...
public class BOM {
    ...
    public void addComponent(ParserComponent component) {
        ...
        Debug.log(Debug.LOG_TYPE.DEBUG, String.format("BOM: Added component \"%s\". UUID: %s",
    ...
    public void addChild(UUID parent, ParserComponent child) throws GeneratorException {
        ...
        Debug.log(Debug.LOG_TYPE.DEBUG, String.format("BOM: Added child component \"%s\" that depends on parent UUID %s",
