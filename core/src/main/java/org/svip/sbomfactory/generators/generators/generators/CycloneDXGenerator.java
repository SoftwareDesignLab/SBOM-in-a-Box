...
import org.svip.sbomfactory.generators.generators.generators.cyclonedx.BOM;
...
public class CycloneDXGenerator extends SBOMGenerator {
    ...
    public void writeFile(String directory, GeneratorSchema.GeneratorFormat format) {
        ...
        Debug.log(Debug.LOG_TYPE.DEBUG, "Building CDX SBOM object");
        try {
            // Build model
            BOM bom = buildCDXBOM();
            ...
            Debug.log(Debug.LOG_TYPE.SUMMARY, "CycloneDX SBOM saved to: " + path);
        } catch (IOException e) {
