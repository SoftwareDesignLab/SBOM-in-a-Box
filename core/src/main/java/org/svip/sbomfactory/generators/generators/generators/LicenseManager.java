...
import org.svip.sbomfactory.generators.generators.utils.SPDXLicenseQueryWorker;
...
public class LicenseManager {
    ...
    static {
        ...
        Debug.log(Debug.LOG_TYPE.DEBUG, String.format("LicenseManager: %d licenses parsed.", numLicenses));
        if(numLicenses < 1)
            Debug.log(Debug.LOG_TYPE.DEBUG, String.format("LicenseManager: No licenses found from %s", licenseWorker.getUrl()));
    }
