package org.svip.sbomfactory.generators.generators.generators.spdx;
...
public class Document {
    ...
    public void addPackage(ParserComponent component) {
        ...
        Debug.log(Debug.LOG_TYPE.DEBUG, "Document: Added component " + component.getName() + " with SPDX ID " + spdxId);
    }
    ...
    public void addDependency(String dependencyId, String dependsOnId) throws GeneratorException {
        ...
        Debug.log(Debug.LOG_TYPE.DEBUG, "Document: Added relationship " + relationship);
    }
