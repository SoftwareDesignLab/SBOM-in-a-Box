...
public class SBOMGenerator {
    ...
    /** TODO make these tokens static constants somewhere
    ...
    public static GeneratorSchema.GeneratorFormat assumeSBOMFormat(String sbom) {
        if (sbom.contains("#####")) return GeneratorSchema.GeneratorFormat.SPDX;
        else if (sbom.contains("<?xml version='1.1' encoding='UTF-8'?>")) return GeneratorSchema.GeneratorFormat.XML;
        else if (sbom.contains("---")) return GeneratorSchema.GeneratorFormat.YAML;
        else return GeneratorSchema.GeneratorFormat.JSON;
    }
