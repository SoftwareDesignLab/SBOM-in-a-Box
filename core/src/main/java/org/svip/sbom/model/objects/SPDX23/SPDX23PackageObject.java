...
//                    conflicts.add(new MismatchConflict("purl", this.purls.toString(), ((CDX14ComponentObject)other).getPURLs().toString(), PURL_MISMATCH));
//                }
...
//                conflicts.add(new MissingConflict("purl", null, ((CDX14ComponentObject)other).getPURLs().toString()));
//            }
//            // CPE
//            if (this.cpes != null && ((CDX14ComponentObject)other).getCPEs() != null) {
//                if (!this.cpes.containsAll(((CDX14ComponentObject)other).getCPEs())) {
//                    conflicts.add(new MismatchConflict("cpe", this.cpes.toString(), ((CDX14ComponentObject)other).getCPEs().toString(), CPE_MISMATCH));
//                }
...
//                conflicts.add(new MissingConflict("cpe", null, ((CDX14ComponentObject)other).getCPEs().toString()));
//            }
