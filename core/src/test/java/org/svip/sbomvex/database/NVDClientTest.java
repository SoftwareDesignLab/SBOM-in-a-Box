...
class NVDClientTest {
    ...
    public void test_generateVEX_valid_VEX_object_CDX_json_sbom() throws IOException {
        ...
        VEX testVEX = nvdClient.generateVEX(test_sbom);
    ...
    @Test
    public void test_generateVEX_valid_VEX_object_unknown_supplier_CDX_json_sbom() throws IOException {
        Set<String> test_cpe1 = new HashSet<>(List.of(
                "cpe:2.3:a:iframe_project:iframe:3.0:*:*:*:*:wordpress:*:*"
        ));
        Set<String> test_cpe2 = new HashSet<>(List.of(
    ...
    @Test
    public void test_generateVEX_null_cpes_CDX_json_sbom() throws IOException {
        Organization test_org1 = new Organization("com.iframe_project", null);
        Organization test_org2 = new Organization("org.bouncycastle", null);
    ...
    @Test
    public void test_generateVEX_empty_cpe_list_CDX_json_sbom() throws IOException {
        Organization test_org1 = new Organization("com.iframe_project", null);
        Organization test_org2 = new Organization("org.bouncycastle", null);
