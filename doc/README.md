...
> Unlike many SBOM tools, SBOM-in-a-Box does **NOT** require package managers or manifest files to generate SBOMs,
> rather as
...
> OSI uses 18 open source tools to support 17 different languages multiple times over. Please read the tool
> documentation
...
Tool configuration files allow for tools to easily be added and removed from OSI. They contain one or more "run
profiles",
