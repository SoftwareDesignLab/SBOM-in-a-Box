...
## [v8.1.0-alpha] - (9/20/2023)

### Added
- `HashFixes.java` Class - Suggests a list of invalid hashes
- `Hash.validAlgorithms()` Method - Returns a list of valid hashing algorithms given a hash
- Missing unit tests
  - `FixTest.java`
  - `HashTest.java`

### Changed
- `Fixes.java` uses generic type `T` 
