...
> Compares two or more given SBOMs (split into filename and contents), with the first one used as the baseline, and
...
**Supported format Params:** `[CycloneDX`](https://github.com/CycloneDX/bom-examples/tree/master/VEX), [
`CSAF`](https://github.com/oasis-tcs/csaf/tree/master/csaf_2.0/examples/csaf/csaf_vex)
