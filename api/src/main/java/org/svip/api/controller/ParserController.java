...
import org.svip.api.services.ParserService;
...
public class ParserController {
     ...
     *
     * @param parserService Service for handling SBOM queries
     */
    ...
    public ResponseEntity<?> generateParsers(@RequestParam("zipFile") MultipartFile zipFile,
        ...
        Long parseId = this.parserService.parseSBOM(zipFile, projectName, schema, format);
