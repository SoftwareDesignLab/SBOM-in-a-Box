...
public class SBOMFile {
     ...
     */
    @Id
    @GeneratedValue(generator = SBOMFileIdentifierGenerator.GENERATOR_NAME)
    @GenericGenerator(name = SBOMFileIdentifierGenerator.GENERATOR_NAME, strategy = "Random Long with modulo")
    private long id;
